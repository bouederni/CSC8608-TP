...
def main():
    ...
    vad_path = "outputs/vad_segments_call_01.json"
    out_path = "outputs/asr_call_01.json"
    ...
    model_id = "openai/whisper-large-v3"  # trouver un modèle de whisper sur HuggingFace
