...
def run_text2img_experiments() -> None:
    model_id = DEFAULT_MODEL_ID
    seed = 42
    prompt = "futuristic grey steampunk watch with intricate cog design"  # TODO: choisissez un prompt e-commerce en anglais unique et gardez-le identique pour tous les runs
    negative = "text, watermark, logo, low quality, blurry, deformed"
...
def run_img2img_experiments() -> None:
    ...
    init_path = "inputs/ex4_img.png"  # ex: "my_product.jpg"

    prompt = "ultra-realistic e-commerce product photo of a compact mini excavator, isolated on a clean white studio background, professional studio lighting, soft shadow under the machine, very sharp details, commercial catalog style, high resolution"   # TODO: prompt e-commerce (en anglais)
    negative = "text, watermark, logo, low quality, blurry, deformed"
